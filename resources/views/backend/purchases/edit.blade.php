...
<div class="card" style="max-width:600px">
    <div class="card-header">Xarid tahrirlash</div>
    <div class="card-body">
        <form method="POST" action="{{ route('backend.purchases.update', $purchase) }}">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="number" name="quantity" class="form-control"
                           value="{{ old('quantity', $purchase->quantity) }}" step="0.01" min="0.01" required>
                </div>
                <div class="col mb-3">
                    <label class="form-label">Tan narxi</label>
                    <input type="number" name="unit_cost" class="form-control"
                           value="{{ old('unit_cost', $purchase->unit_cost) }}" step="0.01" min="0" required>
                </div>
            </div>
            <div class="mb-3">
